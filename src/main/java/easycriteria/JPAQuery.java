...
public class JPAQuery {
    ...
    private <E, S> EasyCriteriaQuery<E, S> createEasyQuery(CriteriaQuery<S> criteriaQuery, EntityManager entityManager, CriteriaBuilder criteriaBuilder, Root<E> root) {
        
        return new EasyCriteriaQuery<E, S>(
                criteriaQuery, 
                new QueryRunner(entityManager),
                new WhereTransformer(criteriaBuilder),
