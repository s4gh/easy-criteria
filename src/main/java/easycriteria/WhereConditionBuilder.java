...
public class WhereConditionBuilder<E, A, S, B extends WhereConditionsContainer> {
	...
	public B greaterThan(A value) {
    	...
    	whereClausesContainer.addWhereClause(new GreaterThanCondition<E, A>((SingularAttribute<E, A>)attribute, value, parentPath));
	...
	public B lessThan(A value) {
    	...
    	whereClausesContainer.addWhereClause(new LessThanCondition<E, A>((SingularAttribute<E, A>)attribute, value, parentPath));
	...
	public B like(String likeString) {
    	...
    	whereClausesContainer.addWhereClause(new LikeCondition<E>((SingularAttribute<E, String>)attribute, likeString, parentPath));
    ...
    /**
     * Access nested property. Access to nested property triggers inner join so parent entities without nested property (null) will not be included into result set
     * 
    ...
    public <A1> WhereConditionBuilder<A, A1, S, B> nested(SingularAttribute<A, A1> nestedAttribute) {
    	return new WhereConditionBuilder<A, A1, S, B>(whereClausesContainer, nestedAttribute, parentPath.get(attribute));
    }
}
